...
window.TRACE_DATA = {
  ...
  queries: {
    total: 12847,
    since: '2025-08-30',
    // 用「分钟前」表达，页面按真实当前时间动态换算，保证演示时永远是"近期"数据
    recent: [
      { minAgo: 3,    place: '西安市 · 长安区', act: '微信扫码验证' },
      { minAgo: 17,   place: '咸阳市 · 秦都区', act: '微信扫码验证' },
      { minAgo: 42,   place: '宝鸡市 · 渭滨区', act: '微信扫码验证' },
      { minAgo: 95,   place: '西安市 · 雁塔区', act: '微信扫码验证' },
      { minAgo: 180,  place: '北京市 · 朝阳区', act: '微信扫码验证' },
      { minAgo: 1500, place: '成都市 · 锦江区', act: '微信扫码验证' },
      { minAgo: 2900, place: '上海市 · 浦东新区', act: '微信扫码验证' },
      { minAgo: 4400, place: '西安市 · 高新区', act: '微信扫码验证' }
    ]
  }
};
